...
//
// Plebanski-Demianski Type A III metric in cylindrical coordinates (t,r,phi,z).
//
...
class ptd_aiii : public metric<coordinate_system_type::cylindrical, scalar_type, vector_type, christoffel_symbols_type>
{
public:
  ...
  __device__ christoffel_symbols_type christoffel_symbols(const vector_type& position) const override
  {
    ...
    const auto t1 = z * z;
    const auto t7 = static_cast<scalar_type>(1) / z;
    const auto t8 = t7 / static_cast<scalar_type>(2);
    const auto t9 = static_cast<scalar_type>(1) / r;
    const auto t10 = r * r;
    ...
    symbols(0, 0, 3) = -static_cast<scalar_type>(1) / t1 / z / static_cast<scalar_type>(2);
    symbols(0, 3, 0) = -t8;
